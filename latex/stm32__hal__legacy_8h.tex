\doxysection{Drivers/\+STM32\+G4xx\+\_\+\+HAL\+\_\+\+Driver/\+Inc/\+Legacy/stm32\+\_\+hal\+\_\+legacy.h File Reference}
\hypertarget{stm32__hal__legacy_8h}{}\label{stm32__hal__legacy_8h}\index{Drivers/STM32G4xx\_HAL\_Driver/Inc/Legacy/stm32\_hal\_legacy.h@{Drivers/STM32G4xx\_HAL\_Driver/Inc/Legacy/stm32\_hal\_legacy.h}}
...
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+TXFIFO\+\_\+\+READ}~0x00100000U  /\texorpdfstring{$\ast$}{*} Tx FIFO read status\+: Read (transferring data to the MAC transmitter) \texorpdfstring{$\ast$}{*}/
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+TXFIFO\+\_\+\+WAITING}~0x00200000U  /\texorpdfstring{$\ast$}{*} Tx FIFO read status\+: Waiting for Tx\+Status from MAC transmitter \texorpdfstring{$\ast$}{*}/
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+TXFIFO\+\_\+\+WRITING}~0x00300000U  /\texorpdfstring{$\ast$}{*} Tx FIFO read status\+: Writing the received Tx\+Status or flushing the Tx\+FIFO \texorpdfstring{$\ast$}{*}/
\item 
...
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+TRANSMITFRAMECONTROLLER\+\_\+\+WAITING}~0x00020000U  /\texorpdfstring{$\ast$}{*} MAC transmit frame controller\+: Waiting for Status of previous frame or IFG/backoff period to be over \texorpdfstring{$\ast$}{*}/
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+TRANSMITFRAMECONTROLLER\+\_\+\+GENRATING\+\_\+\+PCF}~0x00040000U  /\texorpdfstring{$\ast$}{*} MAC transmit frame controller\+: Generating and transmitting a Pause control frame (in full duplex mode) \texorpdfstring{$\ast$}{*}/
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+TRANSMITFRAMECONTROLLER\+\_\+\+TRANSFERRING}~0x00060000U  /\texorpdfstring{$\ast$}{*} MAC transmit frame controller\+: Transferring input frame for transmission \texorpdfstring{$\ast$}{*}/
\item 
...
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+RXFIFO\+\_\+\+BELOW\+\_\+\+THRESHOLD}~0x00000100U  /\texorpdfstring{$\ast$}{*} Rx FIFO fill level\+: fill-\/level below flow-\/control de-\/activate threshold \texorpdfstring{$\ast$}{*}/
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+RXFIFO\+\_\+\+ABOVE\+\_\+\+THRESHOLD}~0x00000200U  /\texorpdfstring{$\ast$}{*} Rx FIFO fill level\+: fill-\/level above flow-\/control activate threshold \texorpdfstring{$\ast$}{*}/
\item 
...
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+READCONTROLLER\+\_\+\+READING\+\_\+\+STATUS}~0x00000040U  /\texorpdfstring{$\ast$}{*} Rx FIFO read controller Reading frame status (or time-\/stamp) \texorpdfstring{$\ast$}{*}/
\item 
\#define {\bfseries ETH\+\_\+\+MAC\+\_\+\+READCONTROLLER\+\_\+\+FLUSHING}~0x00000060U  /\texorpdfstring{$\ast$}{*} Rx FIFO read controller Flushing the frame data and status \texorpdfstring{$\ast$}{*}/
\item 
